  ...
  return (
    <div className=" bg-white dark:bg-gray-900 dark:text-gray-100">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-7xl mx-auto my-8 flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-1/3 space-y-6">
            {/* Map Embed */}
            <div className="relative rounded-lg w-full h-64 bg-gray-200 dark:bg-gray-800 overflow-hidden">
              <iframe
