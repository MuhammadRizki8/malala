...
const ContactForm = () => {
  return (
    <section className="px-4 py-8 md:py-12 max-w-7xl mx-auto  dark:bg-gray-900 transition duration-300">
          ...
          <div>
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  placeholder="Pesan"
                  className="w-full px-4 py-2 border rounded-md h-28 focus:outline-none focus:border-green-500 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-700 dark:focus:border-green-400"
                  required
                ></textarea>
              </div>
