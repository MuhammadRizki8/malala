      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="mb-6 text-gray-600">Kami selalu senang mendengar dari Anda! Apakah Anda memiliki pertanyaan, saran, atau ingin berbagi pengalaman wisata Anda? Jangan ragu untuk menghubungi kami melalui salah satu cara berikut:</p>
            ...
            <form className="space-y-4">
              ...
              <button className="px-6 py-2 bg-green-500 text-white rounded-md hover:bg-green-600">Kirim</button>
            </form>
          </div>
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600">Isi formulir dan Tim kami akan menghubungi Anda dalam waktu 24 jam.</p>
