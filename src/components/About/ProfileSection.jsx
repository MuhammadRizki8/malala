    ...
    <section className="mb-12 w-full mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex items-center justify-center">
          <img src="https://asset.kompas.com/crops/Z8hXwE-DKzO902r9PP89esSDYZo=/0x0:750x500/750x500/data/photo/2022/01/30/61f642eb1956b.jpg" alt="Malala" className="shadow-lg w-full object-cover h-64 sm:h-80 md:h-96" />
        </div>
