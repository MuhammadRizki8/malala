...
const TestimonialCarousel = () => {
  ...
  return (
    <section className="py-8 px-4 md:py-12 md:px-8 bg-gray-50">
      <h2 className="text-center text-2xl md:text-3xl font-bold mb-8 md:mb-10 text-gray-800">What Our Customers Say</h2>
      <div className="flex flex-col sm:flex-row justify-center items-center">
        ...
        <div className="mx-4 sm:mx-8 text-center max-w-md sm:max-w-lg bg-white p-6 sm:p-8 rounded-lg shadow-lg transform transition duration-300 hover:scale-105">
          ...
          <p className="text-gray-600 italic mb-4 sm:mb-6">
