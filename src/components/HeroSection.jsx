  ...
  return (
    <div className="bg-cover bg-center h-[80vh] sm:h-screen w-full" style={{ backgroundImage: `url(${heroImage})` }}>
      <div className="flex flex-col items-center justify-center h-full bg-black bg-opacity-50 px-4">
        ...
        <div className="w-full max-w-sm sm:max-w-md md:max-w-xl lg:max-w-3xl flex flex-col sm:flex-row items-center p-2 space-y-2 sm:space-y-0 sm:space-x-2 bg-transparent rounded-sm">
          ...
          <div className="bg-green-800 hover:bg-green-700 p-2 sm:px-4 text-white font-semibold rounded-full hover:shadow-lg transition duration-300 cursor-pointer w-full sm:w-auto text-center transform hover:scale-105">
