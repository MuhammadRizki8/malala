...
const LocationFilter = () => {
  ...
  return (
    <div className="mx-auto max-w-sm mt-2 lg:p-4 bg-white dark:bg-gray-800  shadow-md">
      <div className="lg:hidden">
        <button
          onClick={() => setIsModalOpen(true)}
          className=" lg:hidden w-full py-2 px-4 text-sm font-medium text-white bg-green-700 rounded-sm hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 flex items-center justify-between"
        >
          Filter
          <FaFilter className="" />
        </button>
      ...
      <Modal
        ...
        className="p-4 bg-white dark:bg-gray-900 rounded-sm shadow-sm max-w-xs mx-auto my-8"
      ...
      >
        ...
        <button onClick={() => setIsModalOpen(false)} className="mt-4 p-2 text-sm font-medium text-white bg-green-700 rounded-sm hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 w-full">
          Tutup
        </button>
      </Modal>
