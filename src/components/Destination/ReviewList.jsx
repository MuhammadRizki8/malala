...
const ReviewList = () => {
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
      <h2 className="text-base md:text-lg font-bold mb-4 text-gray-800 dark:text-gray-100">Ulasan</h2>
      <div className="flex items-center flex-wrap mb-6">
        ...
        <button className="mt-4 sm:mt-0 sm:ml-auto bg-green-500 dark:bg-green-600 text-white py-2 px-3 md:px-4 rounded-lg hover:bg-green-600 dark:hover:bg-green-700 text-sm md:text-base transition duration-300">Berikan ulasanmu</button>
      </div>
      <ul>
        {reviews.map((review) => (
