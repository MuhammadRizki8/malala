  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6 bg-white dark:bg-gray-800 rounded-sm shadow-md">
      ...
      <div className="flex items-center flex-wrap mb-6">
        ...
        <Link to="/onprogress" className="mt-4 sm:mt-0 sm:ml-auto bg-green-500 dark:bg-green-600 text-white py-2 px-3 md:px-4 rounded-sm hover:bg-green-600 dark:hover:bg-green-700 text-sm md:text-base transition duration-300">
          Berikan ulasanmu
        </Link>
      </div>
      <ul>
