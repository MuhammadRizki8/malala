...
const BlogCard = ({ image, title, highlight }) => {
  return (
    <Link to="/onprogress" className=" relative w-full h-36 sm:h-44 lg:h-64 bg-cover bg-center rounded-sm shadow-lg transform transition-transform duration-300 hover:scale-105" style={{ backgroundImage: `url(${image})` }}>
