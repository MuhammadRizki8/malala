const PromotionalBanner = () => {
  return (
    <section className="max-w-screen-xl mx-auto min-h-48 flex flex-col lg:flex-row space-x-4 items-center justify-between  px-4 sm:px-6 lg:px-8 text-white ">
      ...
      <div className="h-48 lg:h-64 lg:w-2/3 text-center lg:text-left mb-6 lg:mb-0 relative bg-cover bg-center rounded-md" style={{ backgroundImage: `url('https://freerangestock.com/sample/143221/beach-from-above.jpg')` }}>
        ...
        <div className="relative z-10 p-6">
          <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl font-medium font-poppins mb-4">Pesan perjalanan wisata yang sempurna dengan pemandu, kiat perjalanan, informasi destinasi, dan inspirasi dari kami.</h2>
